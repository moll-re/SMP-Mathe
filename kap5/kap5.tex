    ...
    \subsection{Lagebeziehungen zwischen Geraden}
        ...
        \begin{center}
            \begin{tikzpicture}[>=triangle 45]
                ...
                \draw (5,-2.8) node{$\exists r,s\in\R\backslash \{ 0\} \quad g = h\quad\Leftrightarrow\quad\textcolor{blue}{\vv{q_1}} + s\cdot\textcolor{red}{\vv{u_1}} = \textcolor{blue}{\vv{q_2}} + r\cdot\textcolor{red}{\vv{u_2}}?$};
