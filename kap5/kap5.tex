...
\section{Geraden}
    ...
    \subsection{Abstand zweier Geraden}
        ...
        \underlin{\textbf{Windschiefe Geraden}}:
            ...
            seien zwei Geraden $g:\vv{x} = \vv{p} + r \cdot \vv{u}; r\in\R$ und $h:\vv{x} = \vv{q} + s \cdot \vv{v}; s\in \R$. Daraus folgt, dass:
            $E:\vv{x} = \vv{p} + r \cdot \vv{u} + s \cdot \vv{v} \lor E:\vv{x} = \vv{q} + r \cdot \vv{u} + s \cdot \vv{v}; s,r\in\R$. Somit ergibt sich eine
