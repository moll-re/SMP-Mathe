    ...
    \subsection{Lagebeziehungen zwischen Geraden}
        ...
        \begin{center}
            \begin{tikzpicture}[>=triangle 45]
                ...
                \draw [->,line width=0.8pt,color=grey] (2,-4) -- (2,-5) node[below]{$g\cap h \neq\varnothing$};
    ...
    \subsection{Darstellungen}
        ...
        \begin{center}
            \begin{tikzpicture}[>=triangle 45]
                ...
                \draw[fill=red, opacity=0.5]  (3,4,4) -- (5,2,-1) -- (8,1,1) -- (6,3,6) -- cycle;
                \foreach \x in {-1,...,5}
        ...
        \begin{center}
            \begin{tikzpicture}[>=triangle 45]
                ...
                \draw[fill=red, opacity=0.5]  (-2,7,7) -- (2,3,-3) -- (8,1,1) -- (4,5,11) -- cycle;
                \foreach \x in {-1,...,6}
                ...
                \draw [->,line width=0.8pt] (5,2,-1) -- (3,4,4);
                \draw [->,line width=0.8pt,color=red] (3,4,4) -- (3.5,9.5,6);
                \draw [line width=0.8pt,color=blue] (0.5,1.5) node {$\vv{q}$};
                \draw [line width=0.8pt] (3.6,2.75) node {$\textcolor{blue}{\vv{q}}-\vv{x}$};
        ...
        \paragraph{} Somit ist jeder Punkt $X\in E$, wenn der Verbindingsvektor $(\textcolor{blue}{\vv{q}}-\vv{x})$ orthogonal zum Vektor
        ...
        \begin{Bemerkung}
            ...
            \begin{enumerate}[1)]
                \item 3 Spurpunkte
                \item 2 Spurpunkte \Rightarrow $E \parallel \vv{x_1} \lor E \parallel \vv{x_2} \lor E \parallel \vv{x_3}$
                \item 1 Spurpunkt \Rightarrow $E \parallel E_{x_{1}x_2} \lor E \parallel E_{x_{2}x_3} \lor E \parallel E_{x_{1}x_3}$
                \item Ausnahme des vorherigen Falls: $P \equiv O \Rightarrow \text{Ausrichtung von $E$ lässt sich nicht bestimmen}$
                \item $inf \text{Punkte} \Rightarrow \text{Eine der Achsen des Koordinatensystems $\in E$, Ausrichtung von $E$ lässt sich nicht bestimmen}$
                \item $inf \glqq \cdot 2 \grqq \text{Punkte} \Rightarrow E \equiv E_{x_{1}x_2} \lor E \equiv E_{x_{2}x_3} \lor E \equiv E_{x_{1}x_3}$
            \end{enumerate}
        \end{Bemerkung}
        ...
        \begin{center}
            \begin{tikzpicture}[>=triangle 45]
                ...
                \draw [->,line width=0.8pt] (3.5,-0.15) -- (-3.5,-0.15);
                \draw [->,line width=0.8pt] (-5.7,-0.3) -- (-1.2,-4.5);
                \draw [->,line width=0.8pt] (-0.8,-4.5) -- (-5.3,-0.3);
                ...
                % Param    E:\vv{x}=\textcolor{blue}{\vv{p}} + s\cdot \textcolor{red}{\vv{u}} + t\cdot \textcolor{red}{\vv{v}}
                % Normal   E:(\vv{x} - \textcolor{blue}{\vv{q}}) \odot \textcolor{red}{\vv{n}} = 0
                % Koor     E:\textcolor{red}{n_1} \cdot x_1 + \textcolor{red}{n_2} \cdot x_2 + \textcolor{red}{n_3} \cdot x_3 = \textcolor{purple}{d} ; \quad \textcolor{purple}{d} = \textcolor{red}{n_1} \cdot \textcolor{blue}{q_1} + \textcolor{red}{n_2} \cdot \textcolor{blue}{q_2} + \textcolor{red}{n_3} \cdot \textcolor{blue}{q_3}
            \end{tikzpicture}
        \end{center}
