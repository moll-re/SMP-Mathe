    ...
    \subsection{Orientierte Winkel}
        ...
        \begin{minipage}{0.5\textwidth}\paragraph{}
            ...
            \begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
                \clip(-2.32,-3) rectangle (6.28,6.16);
        ...
        \begin{minipage}{0.5\textwidth}
            ...
            \begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
                \clip(-3.32,-1) rectangle (6.28,6.16);
...
\section{Skalarprodukt}
    ...
    \begin{minipage}{0.5\textwidth}
        ...
        Multiplikation der Beträge der Anteile von zwei beliebigen Vektoren $\vv{v}$ und $\vv{u}$ auf einer beliebigen Achse
        $l\in E,E=\vv{q}+r\cdot\vv{v}+s\cdot\vv{u};r,s\in\R,Q\in E$. Somit ensteht folgende Formel:
        $\vv{v}\odot\vv{u}=|\vv{v}|\cdot|\vv{u}|\cdot\cos(\alpha);\alpha=(\vv{v},\vv{u})$.
    \end{minipage}
    ...
    \end{Bemerkung}
    \paragraph{} \textbf{Ich weiß net genau, wie ich die andere Formel einführen soll, bzw. diese section im Allgemeinen gestalten soll. Vorschläge sind willkommen.}
