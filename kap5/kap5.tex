...
\section{Kreise und Sphären}
    ...
    \subsection{Kreise}
        ...
        \subsubsection{Tangenten an einen Kreis}
            ...
            \\
            \begin{Definition}
                \paragraph{} Eine Tangente an einen Punkt eines Kreises ist vergleichbar mit der an einen Punkt einer Kurve. Sie ist gerade zu der Geraden equivalent, die \textbf{den Kreis in diesem Punkt berührt}. Dies impliziert auch, dass es nur eine Menge identischer Geraden gibt, welche erfolgreich als Tangente kandidieren können.
            \end{Definition}
            \begin{center}
                \definecolor{purp}{rgb}{0.5,0,0.5}
                \definecolor{lightblue}{rgb}{0,0.7,0.7}
            ...
            \paragraph{} Erneut liefert uns die Graphik eine generelle Formel:
            \\
            \begin{align*}
    ...
    \subsection{Sphären}
        ...
        \begin{Theorem}[- Sphärengleichung]
            \paragraph{} Eine Sphäre im $\R^n ; n \geq 3$ mit Mittelpunkt $M$ und Radius $r$ ist eindeutig über die folgende Gleichung definiert:
                                    $$|\vv{MP}| = r ; P \in M_{\mathscr{C}}$$
            \paragraph{} Die allgebraische Formel lautet somit wie folgt:
