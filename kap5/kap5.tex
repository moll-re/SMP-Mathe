    ...
    \subsection{Darstellungen}
        ...
        \begin{center}
            \begin{tikzpicture}[>=triangle 45]
                ...
                \draw [line width=0.8pt,color=blue] (0.5,1.5) node {$\vv{q}$};
                \draw [line width=0.8pt,color=red] (3.5,2.75) node {$\vv{u_1}$};
                \draw [line width=0.8pt,color=red] (2.3,1.35) node {$\vv{u_2}$};
                \draw [line width=0.8pt] (6,2.65) node {$E$};
            \end{tikzpicture}
        \end{center}

        \paragraph{} Die Normalenform und Parameterform sind weitaus weniger intuitiver und erfordern eine genauere Erklärung. Sie lässt sich
        ...
        \begin{center}
            \begin{tikzpicture}[>=triangle 45]
                ...
                \draw [line width=0.8pt,color=blue] (0.5,1.5) node {$\vv{q}$};
                \draw [line width=0.8pt] (3.6,2.75) node {$\vv{q}-\vv{x}$};
