...
\section{Geraden}
    ...
    \textbf{Parameterform} einer Geraden $g$: $g:\vv{x}=\vv{q}+s\cdot\vv{u};s\in\R$. Diese Schreibweise beschreibt die der Geraden zugehürigen
    Punktmenge. Der Vektor $\vv{q}$ bestimmt die \textbf{Position} der Geraden im Raum und trägt folglich den Namen Stützvektor, wohingegen der Vektor
    $\vv{u}$ die \textbf{Ausrichtung} der Geraden anzeigt und Richtungsvektor genannt wird.
