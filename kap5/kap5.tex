...
<<<<<<< HEAD
    ...
    \end{Beweis}
=======
>>>>>>> cef224b0f24ab8d8aa26bd670887478f46c338af
    ...
    \subsection{Abstand zu einem Punkt}
        ...
        \begin{center}
            ...
            \begin{tikzpicture}[>=triangle 45]
                ...
                \draw[linewidth=0.8pt,color=blu,fill=blu,fill opacity=0.2] (-2,0,2) -- (-1.2,1,2) arc (19.5:360:1) -- cycle;

                \draw[linewidth=0.8pt,color=red] (-2.1,0.2,2.7) node {$R$};
                \draw[linewidth=0.8pt,color=red] (-2.2,1.25,2) node {$\vv{n}$};
