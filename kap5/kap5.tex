...
\section{Geraden}
    ...
    \subsection{Abstand zu einem Punkt}
        ...
        \underline{Orthogonalität}:
            ...
            zum Ziel:
                \begin{enumerate}[1)]
                    \item Punkt L auf der Geraden $g$ in Abhängigkeit des Faktors des Richtungsvektors bestimmen:
                    \begin{center}
                    ...
                    \end{center}
                    \item Verbindungsvektor bestimmen:
                    \begin{center}
                    ...
                    \end{center}
                    \item $\vv{LP}\odot\vv{u} = 0$ und Gleichung lösen (nach t auflösen):
                    \begin{align*}
                    ...
                    \end{align*}
                    \item Verbindungsvektor berechnen:
                    \begin{center}
                    ...
                    \end{center}
                    \item Norm des Verbindungsvektors berechnen:
                    \begin{equation}
                        \begin{split}
                            \qquad \qquad \qquad d(g,P) & =|\vv{LP}| \\
    ...
    \subsection{Abstand zweier Windschiefer Geraden}
    
\\    
Zwei windschiefe Geraden haben einen eindeutig definierten Minimalabstand. Aus zwei Geraden\\
\\
\qquad $g:\vv{x}=\vv{p}+t*\vv{u}, t\in \R$ \qquad und \qquad $h:\vv{x}=\vv{q}+r*\vv{v}, r\in \R$   \\ 
    
    l"asst sich mit dem Kreuzprodukt ein normierter Normalenvektor $n_{0}$ zu beiden Richtungsvektoren $\vv{u}$ und $\vv{v}$ errechnen, den man mit dem Verbindungsvektor der beiden Ortsvektoren ($\vv{q}-\vv{p}$) zur Minimalabstandsberechnung der beiden Geraden skaliert:\\ 
    
   \qquad $d(g,h)= |n_{0} * (\vv{q}-\vv{p})| =  |\dfrac{\vv{u} \times \vv{v}}{|\vv{u} \times \vv{v}|} * (\vv{q}-\vv{p}) |
