...
\section{Winkel zwischen Vektoren}
    ...
    \subsection{Orientierte Winkel}
        ...
        \paragraph{} Wenn man in der Mathematik mit Winkeln arbeitet, werden sie immer im \textbf{mathematisch positiven} Sinn angegeben.
        Dies bedeutet, dass man von einem Vektor oder Schenkel,
        \begin{wrapfigure}[14]{r}{0.4\textwidth}
            ...
            \end{tikzpicture}
        \end{wrapfigure}
        der an den Winkel grenzt, ausgeht und über Rotation um den Schnittpunkt \glqq gegen
...
\section{Skalarprodukt}
    ...
    festzulegen. Zudem lässt sich von dieser Definition aus der Winkel selber anhand der Vektoren bestimmt werden.
