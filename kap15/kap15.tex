...
\center{ $ \vv{F_{g}} =  -\dfrac{G \cdot m_{a} \cdot m_{b}}{r^2} \cdot \vv{u_{AB}}$ } \\
\\

\left Si: \qquad \qquad $r=$AB \qquad \qquad $G=6,67\cdot10^{-11}$(S.I) \qquad \qquad $\vv{u_{AB}} \to$ vecteur normé
\end{Definition}
...
\begin{Definition}
Linteraction éléctromagn�tique est une force \textcolor{red}{attractive} ou \textcolor{red}{répulsive} qui agit sur tout ce qui poss�de une charge éléctrique. Son domaine d'action est également \textcolor{red}{l'infini.}
\end{Definition}
