...
%%%%%PLOUUUUs GRaphehen net vergessen
\end{Beispiel}
...
\begin{Beweis}
Ohne Beschränkung der Allgeminheit nehmen wir an, dass die Folge monoton wachsend sei und sei $a$ die kleinste obere Schranke (Supremum).
\begin{itemize}
...
\end{align*}
Somit ist $u_n$ ab dem 3. Folgeglied \textcolor{blue}{streng monoton fallend} $\Rightarrow S=\dfrac{9}{8}$
\end{itemize}
