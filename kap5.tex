    ...
    \subsection{Kreise}
        ...
        \begin{center}
            ...
            \begin{tikzpicture}[>=triangle 45]
                ...
                \draw[line width=0.8p,color=purp] (2.2,1.7) node {$M_1 (2,2)$};
                ...
                \draw[line width=0.8p,color=purp] (-2.8,-3.3) node {$M_2 (-3,-3)$};
        ...
        \subsubsection{Tangenten an einen Kreis}
            ...
            \begin{center}
                ...
                \begin{tikzpicture}[>=triangle 45]
                    ...
                    \draw[line width=0.8pt,color=grey] (5.3,1.2) node {$t_1$};
                    \draw[line width=0.8pt,color=grey] (-2.8,-0.8) node {$X$};
                    ...
                    \draw[line width=0.8pt,color=grey] (4.4,1.3) node {$X$};
                \end{tikzpicture}
            \end{center}
        ...
        \subsubsection{Polare an einen Kreis}
            ...
            \begin{center}
                ...
                \begin{tikzpicture}[>=triangle 45]
                    ...
                    \draw[line width=0.8pt,color=purp,fill color=purp] (5,0) circle (2pt);
