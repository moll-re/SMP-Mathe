    ...
    \subsection{Besondere Basen}
        ...
        \begin{Definition}[Orthonormalbasis]
          ...
          \end{array} \right ),\vv{e_3}= \left ( \begin{array}{c}
            0\\0\\1
          \end{array} \right )$.
          Sie wird als \textbf{Standardbasis} des $\R^3$ bezeichnet. Vektoren wie $\vv{v}=\left (\begin{array}{c}{2\\3\\8}\end{array} \right )$ lassen sich als eine Linearkombination der drei Vektoren der Standardbasis darstellen: $\vv{v}=2\cdot\vv{e_1}+3\cdot\vv{e_2}+8\cdot\vv{e_3}$.
        \end{Definition}
...
\section{Ebenen}
    ...
    \subsection{Lagebeziehungen zwischen Ebenen}
        ...
        \begin{minipage}[t]{0.5\textwidth}
        \begin{left}
            \quad \text{1. ...\textbf{parallel} sein...}
        \end{left}
        \begin{center}
            \begin{tikzpicture}[>=triangle 45,scale=0.6]
                \draw[color=red,fill=red,opacity=0.5]  (-4,0,4) -- (4,0,4) -- (4,0,-4) -- (-4,0,-4) -- cycle;
        ...
        \begin{minipage}[t]{0.5\textwidth}
        \begin{left}
            \quad \text{2. ...\textbf{identisch} sein}
        \end{left}
        \begin{center}
        ...
        \begin{minipage}[t]{0.5\textwidth}
        \begin{left}
            \quad \text{3.  ...\textbf{sich schneiden}}
        \end{left}
        \begin{center}
            \begin{tikzpicture}[>=triangle 45,scale=0.6]
                \draw[color=red,fill=red,opacity=0.5]  (-4,0,4) -- (4,0,4) -- (4,0,-4) -- (-4,0,-4) -- cycle;
        ...
        \begin{center}
            \begin{tikzpicture}[>=triangle 45]
                ...
                \draw (-5,-2.8) node{$\textcolor{blue}{Q_E_2}\in E_1 \lor \textcolor{blue}{Q_{E_1}}\in E_2?$};
                \draw [line width=0.8pt,color=gray] (-5,-3) -- (-5,-4);
                \draw [line width=0.8pt,color=gray] (-8,-4) -- (-7.6,-4);
                \draw [line width=0.8pt,color=gray] (-6.9,-4) -- (-3.1,-4);
                \draw [line width=0.8pt,color=gray] (-2.4,-4) -- (-2,-4);
    ...
    \subsection{Abstand zu einem Punkt}
        ...
        \begin{Beweis}
            ...
            Daraus folgt:
            \begin{align*}
                \qquad \qquad \dfrac{\textcolor{green}{d}}{|\vv{\textcolor{blue}{Q}P}|} &= \dfrac{\textcolor{red}{\vv{n}} \odot \vv{\textcolor{blue}{Q}P}}{|\textcolor{red}{\vv{n}}| \cdot |\vv{\textcolor{blue}{Q}P}|} \\
...
\subsubsection{Tangenten an einen Kreis}
            ...
            \begin{align*}
                \qquad \qquad \qquad &\vv{MP} \odot \vv{PX} = 0 ; P \in M_K, X \in M_T \text{ mit $M_K$ und $M_T$ Kreis- und Tangentenmenge} \\
                     \Leftrightarrow &(\vv{p} - \vv{m}) \odot (\vv{x} - \vv{p}) = 0 \quad | + (\vv{p} - \vv{m})^2 \\
                     \Leftrightarrow &(\vv{p} - \vv{m}) \odot (\vv{x} - \vv{p}) + (\vv{p} - \vv{m})^2 = (\vv{p} - \vv{m})^2 \\
                     \Leftrightarrow &(\vv{p} - \vv{m}) \odot ((\vv{x} \cancel{- \vv{p}}) + (\cancel{\vv{p}} - \vv{m})) = (\vv{p} - \vv{m})^2 \\
                     \Leftrightarrow &(\vv{p} - \vv{m}) \odot (\vv{x} - \vv{m}) = r^2 \\
            \end{align*}
        ...
        \subsubsection{Polare an einen Kreis}
            ...
            \begin{center}
                ...
                \begin{tikzpicture}[>=triangle 45]
                    ...
                    \draw[line width=0.8pt,color=purple,fill color=purple] (5,0) circle (2pt);
