...
\section{Die Gauß'sche Zahlenebene}
	...
	\subsection{Einleitung}
		...
		\\
		\begin{Definition}
			Als \textbf{Zeiger} wird ein visuelles Hilfsmittel definiert, welches in der Gauß'schen Zahlenebene das Analoge zu dem Pfeil eines Ortsvektors eines Vektorraums ist.
		\end{Definition}
		...
		\begin{Bemerkung}
			Da jede komplexe Zahl eine Darstellung in der Gauß'schen Zahlenebene besitzt, lassen sie sich ebenfalls über einen Winkel und den Abstand zum Nullpunkt beschreiben.
		\end{Bemerkung}

		\begin{Definition}[Betrag einer komplexen Zahl]
			Der \textbf{Betrag} einer komplexen Zahl ist gleichbedeutend mit dem \textbf{Abstand der Zahl zum Nullpunkt} oder der Länge des Zeigers. Pythagoras liefert uns eine Formel:
