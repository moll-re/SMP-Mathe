...
$$f(x\mid \mu ,\sigma ^2) = \dfrac {1}{\sqrt {2\pi \sigma^2}}}e^{-\frac{(x-\mu )^2}{2\sigma ^2}} ; \qquad -\infty <x<\infty$$
\end{Definition}
Warum interessiert uns das? Weil die Binomialverteilung diese symmetrische Kurve für $n\rightarrow\infty$ Versuche annähert. Nicht überzeugt? Über die Varianz können wir interessante Aussagen über die Verteilung der Wahrscheinlichkeiten machen.
\begin{Theorem}
...
\begin{Beweis}
  \begin{align*}
    f(\mu - \sigma \mid \mu ,\sigma ^2) &=& \dfrac {1}{\sqrt {2\pi \sigma^2}}}e^{-\frac{(\mu - \sigma-\mu )^2}{2\sigma ^2}}\\
