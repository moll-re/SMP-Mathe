...
$$\exists! $ $ x_{0} \in I \subseteq D_{f} : f(x_{0}) \geq oder \leq f(x)$$
...
\hfill
\begin{minipage}[b]{0.4\linewidth}
	\s[height=12\baselineskip]{kap3/BundelFunktionenscharen.eps}
\end{minipage}
...
\subsubsection{Weisen Sie nach, dass $K_{a}$ genau einen Hochpunkt und genau einen Tiefpunkt besitzt.

Geben Sie die Koordinaten dieser Punkte in Abhängigkeit von $a$ an und erstellen Sie eine Monotonietabelle der Funktionen $f_{a}$}
